  ...
  return (
    <>
      ...
      <div className="md:hidden group relative w-full h-[290px] mx-auto">
        <svg className="absolute -mt-4 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-base-300" width="70" height="68" viewBox="0 0 238 231" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={`${stepClassesMobile} w-[150px] left-[218px] top-[172px]`} dangerouslySetInnerHTML={{__html: step4}}></div>
