                          ...
                          <ul className="flex flex-wrap gap-3 md:gap-4 text-secondary text-sm md:text-base">
                            {
                              person.links?.website ? (
                                <li>
                                  <a href={person.links?.website} className="flex gap-1 items-center hover:underline">
                              ...
                              ) : ''}
                            {
                              person.links?.lattes ? (
                                <li>
                                  <a href={person.links?.lattes} className="flex gap-1 items-center hover:underline">
                              ...
                              ) : ''}
                            {
                              person.links?.linkedin ? (
                                <li>
                                  <a href={person.links?.linkedin} className="flex gap-1 items-center hover:underline">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
