...
export interface Nav {
    ...
    /** @description Used for highlighting the current page in the navigation */
    pathname?: string;
}
...
export default function NewHeader({ logo = {
    ...
    return (<header className="">
      ...
      {/* Mobile Navigation */}
      <div className="flex lg:hidden px-4 pt-6 justify-between z-30">
        {/* Logo */}
        <div className="flex items-center">
          <a href={logo.href || "/"} className="block w-52">
      ...
      {/* Desktop Navigation */}
      <div className="xl:container mx-auto hidden lg:flex items-center justify-between px-4 mt-12 gap-6">
        {/* Logo */}
        <div className="flex items-center">
        ...
        <nav className="flex items-center">
          ...
          <div className="group ml-5 group text-xs">
