...
export default function PostDetail({
  ...
  const gallery = imageCarousel?.banners?.map((image) => ({
    label: image.alt || "",
    ...
    <div className="container px-6 md:px-12 flex flex-col md:flex-row gap-8 md:gap-44 my-6 md:my-12">
      ...
      <div className="flex flex-auto flex-col gap-9">
        ...
        <div className="flex flex-col gap-9">
          ...
          <div className="leading-normal text-neutral-950 space-y-6 post-content" dangerouslySetInnerHTML={{__html: content}}></div>
        </div>
